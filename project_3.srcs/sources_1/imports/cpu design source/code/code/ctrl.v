...
// i format
 ...
 assign RegWrite   = rtype | itype_r | i_jalr | i_jal|itype_l|i_lui|i_auipc|i_lw; // register write
  assign MemWrite   = stype;                           // memory write
  assign ALUSrc     = itype_r | stype | i_jal | i_jalr|itype_l|i_auipc|i_lui;   // ALU B is from instruction immediate
  ...
  // WDSel_FromMEM 2'b01
  // WDSel_FromPC  2'b10 
  assign WDSel[0] = itype_l;                // 加载指令从内存获取数???
  ...
  assign DMType[0] = i_lh | i_sh | i_sb | i_lb;  // 半字或字节访??
    assign DMType[1] = i_lhu | i_sb | i_lb;        // 无符号半字或字节访问
